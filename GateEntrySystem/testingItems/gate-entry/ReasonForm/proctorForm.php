      ...
      <div class="main-content">
        <div class="form-container">
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            <form class="form" method="post">
              ...
              <div class="form-row">
                ...
                <textarea name="reason" placeholder="Fill Reason"></textarea>
              </div>
              <div class="form-row">
          ...
          if (isset($_POST["btn"])) {
            ...
            $sql = "INSERT INTO inqury_data(name,dprt,year,contact,reason,status,photo_url) values('{$name}','{$dept}','{$year}','{$num}','{$reason}','{$issue}','{$photo}')";
            $result = mysqli_query($conn, $sql);
